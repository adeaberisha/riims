            ...
            <div className="row h-100">
                ...
                <div className="col-md-10 d-flex flex-column align-items-center py-5">
                    <div className="col-12 col-md-10 col-lg-8 col-xl-6" style={{ marginTop: '-1.4rem' }}>
                        <h4 className="text-center text-muted fst-italic mb-3">Shtoni punën vullnetare</h4>
                        
                        {message && (
                            <div className={`alert text-center mb-3 ${messageType === 'success' ? 'alert-success' : 'alert-danger'}`} role="alert">
                                {message}
                            </div>
                        )}
