                ...
                <div className="row justify-content-center align-items-center h-100">
                    <div className="col-lg-7 pt-2">
                        <div className="user-details-container ml-4 pl-4">
                            <div className="row align-items-start"> {/* Use align-items-start to align items at the top */}
                                <div className="col-lg-4 text-center mb-4"> {/* Added margin-bottom here */}
                        ...
                        <div className="box text-center bg-white shadow p-3 d-flex flex-column justify-content-center align-items-center">
                            <Link to="/personDetails" className="d-block text-decoration-none">
                                ...
                                <div className="box-content mt-3">
                                    <h4 className="fst-italic mb-3" style={{ color: '#244082' }}>Detajet e CV</h4>
                                </div>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="box text-center bg-white shadow p-3 d-flex flex-column justify-content-center align-items-center">
                            <Link to="/aftesite" className="d-block text-decoration-none">
                                ...
                                <div className="box-content mt-3">
                                    <h4 className="fst-italic mb-3" style={{ color: '#244082' }}>Shto aftësi</h4>
                                </div>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="box text-center bg-white shadow p-3 d-flex flex-column justify-content-center align-items-center">
                            <Link to="/edukimi" className="d-block text-decoration-none">
                                ...
                                <div className="box-content mt-3">
                                    <h4 className="fst-italic mb-3" style={{ color: '#244082' }}>Shto edukim</h4>
                                </div>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="box text-center bg-white shadow p-3 d-flex flex-column justify-content-center align-items-center">
                            <Link to="/eksperienca" className="d-block text-decoration-none">
                                ...
                                <div className="box-content mt-3">
                                    <h4 className="fst-italic mb-3" style={{ color: '#244082' }}>Shto eksperiencë</h4>
                                </div>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="box text-center bg-white shadow p-3 d-flex flex-column justify-content-center align-items-center">
                            <Link to="/gjuhet" className="d-block text-decoration-none">
                                ...
                                <div className="box-content mt-3">
                                    <h4 className="fst-italic mb-3" style={{ color: '#244082' }}>Shto gjuhë</h4>
                                </div>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="box text-center bg-white shadow p-3 d-flex flex-column justify-content-center align-items-center">
                            <Link to="/licensat" className="d-block text-decoration-none">
                                ...
                                <div className="box-content mt-3">
                                    <h4 className="fst-italic mb-3" style={{ color: '#244082' }}>Shto licensë</h4>
                                </div>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="box text-center bg-white shadow p-3 d-flex flex-column justify-content-center align-items-center">
                            <Link to="/mbikqyresitemave" className="d-block text-decoration-none">
                                ...
                                <div className="box-content mt-3">
                                    <h4 className="fst-italic mb-3" style={{ color: '#244082' }}>Shto mbikqyrës temash</h4>
                                </div>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="box text-center bg-white shadow p-3 d-flex flex-column justify-content-center align-items-center">
                            <Link to="/honorsandawards" className="d-block text-decoration-none">
                                ...
                                <div className="box-content mt-3">
                                    <h4 className="fst-italic mb-3" style={{ color: '#244082' }}>Shto nderim/çmim</h4>
                                </div>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="box text-center bg-white shadow p-3 d-flex flex-column justify-content-center align-items-center">
                            <Link to="/projekti" className="d-block text-decoration-none">
                                ...
                                <div className="box-content mt-3">
                                    <h4 className="fst-italic mb-3" style={{ color: '#244082' }}>Shto projekt</h4>
                                </div>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="box text-center bg-white shadow p-3 d-flex flex-column justify-content-center align-items-center">
                            <Link to="/publikimi" className="d-block text-decoration-none">
                                ...
                                <div className="box-content mt-3">
                                    <h4 className="fst-italic mb-3" style={{ color: '#244082' }}>Shto publikim</h4>
                                </div>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="box text-center bg-white shadow p-3 d-flex flex-column justify-content-center align-items-center">
                            <Link to="/punavullnetare" className="d-block text-decoration-none">
                                ...
                                <div className="box-content mt-3">
                                    <h4 className="fst-italic mb-3" style={{ color: '#244082' }}>Shto punë vullnetare</h4>
                                </div>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4 mb-4">
                        <div className="box text-center bg-white shadow p-3 d-flex flex-column justify-content-center align-items-center">
                            <Link to="/specializimet" className="d-block text-decoration-none">
                                ...
                                <div className="box-content mt-3">
                                    <h4 className="fst-italic mb-3" style={{ color: '#244082' }}>Shto specializim</h4>
                                </div>
                            </Link>
                        </div>
                    </div>
